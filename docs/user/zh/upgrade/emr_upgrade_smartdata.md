...
-rw-r--r-- 1 root   root   16264149 Apr 24 16:19 jindo-core-6.6.0.jar
-rw-r--r-- 1 root   root   14429862 Apr 24 16:19 jindo-core-linux-el7-aarch64-6.6.0.jar
-rw-r--r-- 1 root   root    4459297 Apr 24 16:19 jindo-sdk-6.6.0.jar
...
下载的 jindosdk-patches.tar.gz ，jindosdk-6.6.0-linux.tar.gz 和 bootstrap_jindosdk.sh。
