...
执行以下命令，下载6.5.4版本JindoSDK TAR包。以大多数linux x86环境为例。其他平台部署参见[《在多平台环境安装部署 JindoSDK》](../jindosdk/jindosdk_deployment_multi_platform.md)
...
以安装包内容解压在 /usr/lib/jindosdk-6.5.4-linux 目录为例：
