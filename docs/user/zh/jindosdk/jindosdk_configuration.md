...
| fs.oss.list.iterative.first           |  布尔值  | false | 打开后，listStatus 默认走迭代实现。                                                                                                                                                                                                                                         | 6.10.7+ nextarch |
| fs.oss.server-side-encryption         |  字符串  | ''    | 示例值，AES256。也兼容 hadoop 社区风格的 `fs.oss.server-side-encryption-algorithm`，具体说明参见 [x-oss-server-side-encryption](https://help.aliyun.com/zh/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC)。                        | 6.10.7+ nextarch |
| fs.oss.server-side-data-encryption         |  字符串  | ''    | 示例值，SM4。具体说明参见 [x-oss-server-side-data-encryption](https://help.aliyun.com/zh/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC)。                                                                                 | 6.10.7+ nextarch |
| fs.oss.server-side-encryption-key-id         |  字符串  | ''    | 示例值，9468da86-3509-4f8d-a61e-6eab1eac****。也兼容 hadoop 社区风格的`server-side-encryption.key`。具体说明参见 [x-oss-server-side-encryption-key-id](https://help.aliyun.com/zh/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC)。 | 6.10.7+ nextarch |
