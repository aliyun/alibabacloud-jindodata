...
以升级为 6.10.0 版本为例，返回示例如下：
```bash
drwxr-xr-x 2 root   root       4096 Apr 24 15:49 flink
-rw-r--r-- 1 hadoop hadoop   189081 Apr 24 15:20 hadoop-lzo-0.4.21-SNAPSHOT.jar
-rw-r--r-- 1 root   root   16264149 Apr 24 15:49 jindo-core-6.10.0.jar
-rw-r--r-- 1 root   root   14429862 Apr 24 15:49 jindo-core-linux-el7-aarch64-6.10.0.jar
-rw-r--r-- 1 root   root    4459297 Apr 24 15:49 jindo-sdk-6.10.0.jar
...
下载的 jindosdk-patches.tar.gz ，jindosdk-6.10.0-linux.tar.gz 和 bootstrap_jindosdk.sh。
