...
以将新版集群中的 JindoSDK 升级到 6.7.3 版本，linux x86 平台为例:
...
-rw-r----- 1 emr-user emr-user xxxxxxxxx May 01 00:00 jindosdk-6.7.3-linux.tar.gz
...
以将新版集群中的 JindoSDK 升级到 6.7.3 版本，linux x86平台为例:
