...
以将新版集群中的 JindoSDK 升级到 6.5.6 版本，linux x86 平台为例:
...
-rw-r----- 1 emr-user emr-user xxxxxxxxx May 01 00:00 jindosdk-6.5.6-linux.tar.gz
...
以将新版集群中的 JindoSDK 升级到 6.5.6 版本为例:
...
以从集群默认版本 6.2.0 升级为 6.5.6 版本为例，返回示例如下：
```bash
...
以将新版集群中的 JindoSDK 升级到 6.5.6 版本，linux x86平台为例:
