...
2.  部署 jindosdk-6.7.5.tar.gz，whl安装包位于完整产出物 `jindosdk-x.x.x/lib/site-packages/` 的子目录中。多平台部署说明参见 [部署文档](../jindosdk_deployment_multi_platform.md)。
...
以 Python3.8 环境安装最新版本的 pyjindo-6.7.5 为例
