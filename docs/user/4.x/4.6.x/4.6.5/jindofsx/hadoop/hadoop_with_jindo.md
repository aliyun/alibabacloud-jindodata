...
OSS Bucket 参考 [JindoSDK OSS Credential Provider 配置](/docs/user/4.x/4.6.x/4.6.5/oss/security/jindosdk_credential_provider_oss.md)。

OSS-HDFS 服务 Bucket 参考 [JindoSDK OSS-HDFS 服务 Credential Provider 配置](/docs/user/4.x/4.6.x/4.6.5/jindofs/security/jindosdk_credential_provider_dls.md)。
...
如果统一挂载的为 OSS-HDFS 服务目录，配置 Endpoint 请参考 [OSS-HDFS 服务 Endpoint 配置](/docs/user/4.x/4.6.x/4.6.5/jindofs/configuration/jindosdk_endpoint_configuration.md)。
...
```
更多缓存优化相关参数，请参考 [缓存优化相关参数](/docs/user/4.x/4.6.x/4.6.5/jindofsx/configuration/jindosdk_configuration_list.md)
...
## 参数调优
JindoSDK 包含一些高级调优参数，配置方式以及配置项参考文档 [JindoSDK 配置项列表](/docs/user/4.x/4.6.x/4.6.5/jindofsx/configuration/jindosdk_configuration_list.md)