...
jindosdk 4.6.10 及以上版本在 tar 包中默认携带了 jemalloc：
...
│   ├── ...
├── lib
│   ├── jindo-core-4.6.10.jar
│   ├── jindo-sdk-4.6.10.jar
│   └── native
│       ├── libjemalloc.so
│       ├── ...
├── plugins
...
`HADOOP_HEAPSIZE=2560 HADOOP_ROOT_LOGGER=ERROR,console  hadoop jar jindo-sdk-memleak-check-1.0.jar MemLeakTestProgram  -baseDir oss://yanbin-hd2-test/ -duration 8899`
