...
wget https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/release/4.6.1/jindosdk-4.6.1.tar.gz
...
-rw-r----- 1 emr-user emr-user xxxxxxxxx May 01 00:00 jindosdk-4.6.1.tar.gz
```
...
下载的 jindosdk-patches.tar.gz ，jindosdk-4.6.1.tar.gz 和 [bootstrap_jindosdk.sh](https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/resources/emr-taihao/bootstrap_jindosdk.sh),
...
-rw-r----- 1 hadoop hadoop xxxxxxxxx May 01 00:00 jindosdk-4.6.1.tar.gz
...
```bash
bash bootstrap_jindosdk.sh -gen 4.6.1 4.4.2
```
