...
### 1、配置 COS 相关实现类和用户信息
修改Hadoop的`core-site.xml`，增加 COS 相关用户和实现类信息。
```xml
<configuration>
    <property>
...
```
JindoSDK还支持更多的OSS AccessKey的配置方式，详情参考[JindoSDK Credential Provider 配置](../security/jindosdk_credential_provider.md)。<br />
