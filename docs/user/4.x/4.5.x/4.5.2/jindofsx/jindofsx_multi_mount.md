...
可参考 [JindoFSx 挂载 OSS 数据源](/docs/user/4.x/4.5.x/4.5.2/jindofsx/oss/jindofsx_on_oss_jindo.md)
...
可参考 [JindoFSx 挂载 OSS-HDFS 数据源](/docs/user/4.x/4.5.x/4.5.2/jindofsx/jindofs/jindofsx_on_jindofs_jindo.md)
...
[JindoFSx 挂载 S3 数据源](/docs/user/4.x/4.5.x/4.5.2/jindofsx/multi-cloud/jindofsx_on_multi_cloud.md)

[JindoFSx 挂载 HDFS 数据源](/docs/user/4.x/4.5.x/4.5.2/jindofsx/hdfs/jindofsx_on_hdfs_jindo.md)

[JindoFSx 挂载 NAS 数据源](/docs/user/4.x/4.5.x/4.5.2/jindofsx/nas/jindofsx_on_nas_jindo.md)
