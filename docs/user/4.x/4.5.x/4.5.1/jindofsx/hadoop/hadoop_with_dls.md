...
```
更多缓存优化相关参数，请参考 [缓存优化相关参数](/docs/user/4.x/4.5.x/4.5.1/jindofsx/configuration/jindosdk_configuration_list.md)
...
## 参数调优
JindoSDK 包含一些高级调优参数，配置方式以及配置项参考文档 [JindoSDK 配置项列表](/docs/user/4.x/4.5.x/4.5.1/jindofsx/configuration/jindosdk_configuration_list.md)