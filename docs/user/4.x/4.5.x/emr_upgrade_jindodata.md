...
wget https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/release/4.4.2/jindofsx-4.4.2.tar.gz
...
-rw-r----- 1 hadoop hadoop xxxxxxxxx May 01 00:00 jindofsx-4.4.2.tar.gz
```
