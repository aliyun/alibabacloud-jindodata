...
wget https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/release/4.3.1/jindosdk-4.3.1.tar.gz
...
-rw-r----- 1 hadoop hadoop xxxxxxxxx May 01 00:00 jindosdk-4.3.1.tar.gz
```
...
下载的 jindosdk-patches.tar.gz ，jindosdk-4.3.1.tar.gz 和 [bootstrap_jindosdk.sh](https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/resources/bootstrap_jindosdk.sh),
...
```bash
bash bootstrap_jindosdk.sh -gen 4.3.1
```
