...
安装方式的话，即可以通过maven在pom.xml中配置依赖，如[6.3.0-oss-maven](/docs/user/jindosdk/oss-maven.md)。也可以通过oss地址直接下载部署，如[6.3.0-download](/docs/user/jindosdk/jindosdk_download.md)。
