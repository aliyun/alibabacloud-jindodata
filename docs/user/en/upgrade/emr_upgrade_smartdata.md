...
Download `jindosdk-patches.tar.gz`, `jindosdk-6.5.0-linux.tar.gz`, and `[bootstrap_jindosdk.sh](https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/resources/bootstrap_jindosdk.sh)`.
...
```bash
bash bootstrap_jindosdk.sh -gen 6.5.0
```
...
Download the `jindosdk-patches.tar.gz`, `jindosdk-6.5.0-linux.tar.gz`, and `[bootstrap_jindosdk.sh](https://jindodata-binary.oss-cn-shanghai.aliyuncs.com/resources/bootstrap_jindosdk.sh)` files.
