...
Let's take version 6.5.1 as an example.

## Linux x86 Example

### Full Installation
Assuming the extracted folder is placed at `/usr/lib/jindosdk-6.5.1-linux`:
...
### Full Installation
Assuming the extracted folder is placed at `/usr/lib/jindosdk-6.5.1-linux-el7-aarch64`:
