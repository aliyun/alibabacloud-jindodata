...
Installation can be done through Maven by adding dependencies in `pom.xml` (refer to [6.8.1-OSS-Maven](oss-maven.md)) or directly downloading and deploying from OSS (see [6.8.1-Download](jindosdk_download.md)).
...
Let's take version 6.8.1 as an example.

## Linux x86 Example

### Full Installation
Assuming the extracted folder is placed at `/usr/lib/jindosdk-6.8.1-linux`:
...
### Full Installation
Assuming the extracted folder is placed at `/usr/lib/jindosdk-6.8.1-linux-el7-aarch64`:
