...
| fs.oss.list.iterative.first | Boolean | false | When enabled, `listStatus` uses the iterative implementation by default.                                                                                                                                                                                                                                                                      | 6.10.7+ nextarch |
| fs.oss.server-side-encryption | String | '' | Example value: AES256. Also compatible with the Hadoop community-style `fs.oss.server-side-encryption-algorithm`. For details, see [x-oss-server-side-encryption](https://help.aliyun.com/en/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC).                                                | 6.10.7+ nextarch |
| fs.oss.server-side-data-encryption | String | '' | Example value: SM4. For details, see [x-oss-server-side-data-encryption](https://help.aliyun.com/en/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC).                                                                                                                                         | 6.10.7+ nextarch |
| fs.oss.server-side-encryption-key-id | String | '' | Example value: 9468da86-3509-4f8d-a61e-6eab1eac****. Also compatible with the Hadoop community-style `server-side-encryption.key`. For details, see [x-oss-server-side-encryption-key-id](https://help.aliyun.com/en/oss/developer-reference/putobject?spm=a2c4g.11186623.help-menu-31815.d_1_0_5_0_0.6b0f71551eDUaC).                        | 6.10.7+ nextarch |
