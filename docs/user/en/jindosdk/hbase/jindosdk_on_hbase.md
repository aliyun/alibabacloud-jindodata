...
For example, with jindosdk-6.10.4:

```bash
cp jindosdk-6.10.4/lib/jindo-core-6.10.4.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.10.4/lib/jindo-sdk-6.10.4.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
