...
For example, with jindosdk-6.7.8:

```bash
cp jindosdk-6.7.8/lib/jindo-core-6.7.8.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.7.8/lib/jindo-sdk-6.7.8.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
