...
For example, with jindosdk-6.10.2:

```bash
cp jindosdk-6.10.2/lib/jindo-core-6.10.2.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.10.2/lib/jindo-sdk-6.10.2.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
