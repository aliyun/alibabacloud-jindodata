...
For example, with jindosdk-6.9.0:

```bash
cp jindosdk-6.9.0/lib/jindo-core-6.9.0.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.9.0/lib/jindo-sdk-6.9.0.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
