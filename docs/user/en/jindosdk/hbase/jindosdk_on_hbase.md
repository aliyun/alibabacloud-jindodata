...
For example, with jindosdk-6.10.5:

```bash
cp jindosdk-6.10.5/lib/jindo-core-6.10.5.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.10.5/lib/jindo-sdk-6.10.5.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
