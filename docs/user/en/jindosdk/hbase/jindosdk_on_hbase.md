...
For example, with jindosdk-6.5.6:

```bash
cp jindosdk-6.5.6/lib/jindo-core-6.5.6.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.5.6/lib/jindo-sdk-6.5.6.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
