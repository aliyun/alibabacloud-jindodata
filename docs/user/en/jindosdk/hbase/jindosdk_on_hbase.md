...
For example, with jindosdk-6.3.3:

```bash
cp jindosdk-6.3.3/lib/jindo-core-6.3.3.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.3.3/lib/jindo-sdk-6.3.3.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
