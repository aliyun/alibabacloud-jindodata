...
For example, with jindosdk-6.9.1:

```bash
cp jindosdk-6.9.1/lib/jindo-core-6.9.1.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.9.1/lib/jindo-sdk-6.9.1.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
