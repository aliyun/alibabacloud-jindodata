...
For example, with jindosdk-6.10.7:

```bash
cp jindosdk-6.10.7/lib/jindo-core-6.10.7.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
cp jindosdk-6.10.7/lib/jindo-sdk-6.10.7.jar <HADOOP_HOME>/share/hadoop/hdfs/lib/
```
